<%@ Page Title="" Language="C#" MasterPageFile="~/bio/ventas/A_contabilidad/contabilidad.Master" AutoEventWireup="true" CodeBehind="ComprasViaticos.aspx.cs" Inherits="biotech.bio.ventas.A_contabilidad.ComprasViaticos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>RENDICIÓN DE GASTOS - VIATICOS</h2>
    ...
    Registro contable detallado:<span class="auto-style3"> (Excluye gastos al credito)</span>
        ...
        <table class="auto-style1">
            <tr>
                <td>
                 ...
                 <td colspan="4"><strong>GLOSA:</strong><br />
            ...
            <tr>
                <td>
                    ...
                    <br />
                    Centro de costo:<asp:SqlDataSource ID="SqlDataSourceidcentocosto" runat="server" ConnectionString="<%$ ConnectionStrings:CorporacionAgroConnectionString %>" SelectCommand="select idCentroCosto,Descripcion from gastos.CentroCosto
...
"></asp:SqlDataSource>
    ...
    <asp:GridView ID="gvViaticos" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceViaticos" Font-Size="X-Small" Width="100%" DataKeyNames="COD_DETCTA,GLOSA" OnSelectedIndexChanged="gvViaticos_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AllowSorting="True">
        <Columns>
...
<asp:SqlDataSource ID="SqlDataSourceViaticos" runat="server" ConnectionString="<%$ ConnectionStrings:CorporacionAgroConnectionString %>" SelectCommand="st_concar_ventas_viatico" SelectCommandType="StoredProcedure">
    <SelectParameters>
