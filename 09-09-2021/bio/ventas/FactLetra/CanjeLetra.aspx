<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CanjeLetra.aspx.cs" Inherits="biotech.bio.ventas.FactLetra.CanjeLetra" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style3" colspan="8">
                    ...
                    <br />
        <asp:Label ID="lblmensaje" runat="server" style="color: #990000; font-size: small" Visible="False"></asp:Label>
                </td>
            </tr>
        </table>
