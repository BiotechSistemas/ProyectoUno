<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="biotech.VentasRTC.ensayos.Default" %>
...
&nbsp;</div>
				<div class="w3l-sym">
					...
					<asp:TextBox ID="txtcantidad" type="number" runat="server" required Height="30px" Width="100%"></asp:TextBox>
			...
			<div class="clear"></div>
                ...
                <div class="w3l-user">
                    <label class="head">Productos a competir<span class="w3l-star"> * </span></label>
                <asp:TextBox ID="txtcompetencia" runat="server" required></asp:TextBox>
			</div>

			<div class="w3l-user">
                <label class="head">Precios a competir<span class="w3l-star"> * </span></label>
                <asp:TextBox ID="txtcompePrecProductos" runat="server" required></asp:TextBox>
			</div>
