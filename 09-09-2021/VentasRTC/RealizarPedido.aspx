<%@ Page Title="" Language="C#" MasterPageFile="~/VentasRTC/rtc.Master" AutoEventWireup="true" CodeBehind="RealizarPedido.aspx.cs" Inherits="biotech.VentasRTC.RealizarPedido" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="control-group">
    ...
    <div class="control-group">
    <label class="control-label">P. Referencial (40%):<span class="required">*</span></label>
    <div class="controls">
