<%@ Page Title="" Language="C#" MasterPageFile="~/VentasRTC/rtc.Master" AutoEventWireup="true" CodeBehind="EnsayoA.aspx.cs" Inherits="biotech.VentasRTC.EnsayoA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    SOLICITUD DE ENSAYO N°<asp:Label ID="lblano" runat="server"></asp:Label>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="controls">
        ...
        <div class="control-group">
    <label class="control-label">Cliente Biotech:<span class="required">*</span></label>
    <div class="controls">
        
        <asp:RadioButtonList ID="RBLcliente" runat="server" RepeatDirection="Horizontal" Width="150px" AutoPostBack="True" OnSelectedIndexChanged="RBLcliente_SelectedIndexChanged">
    ...
    <div class="controls">
        ...
        <asp:LinkButton ID="LinkButton4" runat="server" class="btn" OnClick="LinkButton4_Click">Buscar</asp:LinkButton>
    ...
    <div class="controls">
        ...
        <asp:LinkButton ID="LinkButton5" runat="server" class="btn" OnClick="LinkButton5_Click">Verificar estado</asp:LinkButton>
...
&nbsp;
        ...
        <asp:Panel ID="PanelnoCliente" runat="server">
   
                 <div class="control-group">
    <label class="control-label">RUC/DNI<span class="required">*</span></label>
    <div class="controls">
        
    <asp:TextBox ID="txtdni" runat="server" class="span3" type="number" step="0.01" placeholder="DOCUMENTO" Width="120px" MaxLength="12"  ></asp:TextBox>
        <asp:TextBox ID="txtnombre" runat="server" Width="300px" Style="text-transform: uppercase" placeholder="RAZON SOCIAL" MaxLength="50"></asp:TextBox>
    </div>
    </div><!-- / .control-group -->  

                 <div class="control-group">
    <label class="control-label">Cultivo:<span class="required">*</span></label>
    <div class="controls">
        
        <asp:DropDownList ID="ddlCutivoensayo" runat="server" DataSourceID="SqlDataSource7" DataTextField="descripcion" DataValueField="idtipocultivo" Width="300px">
        </asp:DropDownList>
  ...
  <asp:Panel ID="Paneldatoscultivo" runat="server">
    ...
    <asp:TextBox ID="txthectaraensayo" required runat="server" class="span3" type="number" step="0.01" placeholder="Hectárea de ensayo"  ></asp:TextBox>
    </div>
    </div><!-- / .control-group -->  
    ...
    <asp:TextBox ID="txtpuntollegada" required runat="server" class="span5" Style="text-transform: uppercase" placeholder="Punto llegada"  ></asp:TextBox>
    </div>
    </div><!-- / .control-group --> 
    ...
    <asp:TextBox ID="txtfecharequeridaa" required runat="server" class="span5" TextMode="Date"   ></asp:TextBox>
    </div>
    </div><!-- / .control-group --> 
...
&nbsp;
 ...
 <span class="title_section_offer">5. Cronograma de actividades</span>
    ...
    <div class="controls">
        ...
        <asp:Button ID="Button4" runat="server" Text="SOLICITAR MUESTRA" class="btn" OnClick="Button4_Click"/>
