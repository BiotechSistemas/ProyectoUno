<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotaCredito.aspx.cs" Inherits="biotech.documento.NotaCredito" %>
            ...
            <tr>
                ...
                <td WIDTH="270">
                    ...
                    <div class="auto-style2"  style="width:270px">
                        ...
                        <h1 >
                            NOTA DE CRÉDITO<br /> ELECTRÓNICA</h1>
                        
                       <h2 >
                        
                        <asp:Label ID="lblgrupoNC" runat="server"></asp:Label>
                           Nº<asp:Label ID="lblnumNC" runat="server"></asp:Label>
                       </h2>
                            <br />   <br />
    ...
    <div id="muestra"> 
        ...
        <table class="auto-style1">
            <tr>
                <td WIDTH="10px" ></td>
                <td WIDTH="80" >
                        <asp:Label ID="lblidNC" runat="server" Visible="False"></asp:Label>
                       </td>
                <td WIDTH="5" ></td>
                <td WIDTH="250" >
                    <asp:Label ID="lblserieNC" runat="server"></asp:Label>
                </td>
                <td WIDTH="80" >
            ...
            <asp:Panel ID="Panel2" runat="server">
                ...
                ,&nbsp; idfactura
                <asp:Label ID="lblidfacturaNC" runat="server"></asp:Label>
                &nbsp;&nbsp; importe factura
                <asp:Label ID="lblimporteNC" runat="server"></asp:Label>
                &nbsp;COD ANULACION:</asp:Panel>
           <br />
            </div><br />
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="COD" DataSourceID="SqlDataSource2" Width="750px" OnRowDataBound="GridView1_RowDataBound" BorderStyle="Solid" GridLines="Horizontal" >
                            <Columns>
                                ...
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                 ...
                                 <asp:BoundField DataField="BS" HeaderText="B/S" SortExpression="BS" Visible="False" >
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CorporacionAgroConnectionString %>" SelectCommand="st_FacturaListarPedidos" DeleteCommand="DELETE FROM [FacturacionDetalle] WHERE [idDetalle] = @idDetalle" InsertCommand="INSERT INTO [FacturacionDetalle] ([idDetalle], [idfactura], [idproducto], [precioVenta], [cantidad], [subtotal], [idPedido], [dsto]) VALUES (@idDetalle, @idfactura, @idproducto, @precioVenta, @cantidad, @subtotal, @idPedido, @dsto)" UpdateCommand="UPDATE [FacturacionDetalle] SET [idfactura] = @idfactura, [idproducto] = @idproducto, [precioVenta] = @precioVenta, [cantidad] = @cantidad, [subtotal] = @subtotal, [idPedido] = @idPedido, [dsto] = @dsto WHERE [idDetalle] = @idDetalle" SelectCommandType="StoredProcedure">
                            ...
                            <SelectParameters>
                                <asp:ControlParameter ControlID="lblidfacturaNC" Name="idfact" PropertyName="Text" Type="Int32" />
                            </SelectParameters>
                            <UpdateParameters>
                                <asp:Parameter Name="idfactura" Type="Int32" />
                                <asp:Parameter Name="idproducto" Type="String" />
            ...
            <tr align=left>
                ...
                <td valign=bottom align=left colspan="3">
                    ...
                    <table  class="auto-style11" >
                        <tr>
                            <td align=center class="auto-style12">Documento de referencia</td>
                            <td align=center class="auto-style12">Número de referencia</td>
                            <td align=center class="auto-style12">Código</td>
                            <td align=center class="auto-style12">Referencia</td>
                        </tr>
                        <tr>
                            <td align=center  >
                                <asp:Label ID="lblFactBoleta" runat="server"></asp:Label>
                                <asp:Label ID="lblcodtp_comprobante" runat="server"></asp:Label>
                            </td>
                            <td align=center>
                                <asp:Label ID="lblFactura" runat="server"></asp:Label>
                            </td>
                            <td align=center>
                                <asp:Label ID="lblcodAnulacion" runat="server"></asp:Label>
                            </td>
                            <td align=center>
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td>
                        &nbsp;</td>
                    <td>
                        <asp:Button ID="bt_rptaSunat" runat="server" Enabled="False" Height="30px" OnClick="bt_rptaSunat_Click" Text="RESPUESTA SUNAT" Width="150px" Visible="False" />
                    </td>
